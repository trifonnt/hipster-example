...
@RestController
@RequestMapping("/api/hipster-example-kafka")
public class HipsterExampleKafkaResource {

    private final Logger log = LoggerFactory.getLogger(HipsterExampleKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public HipsterExampleKafkaResource(KafkaProperties kafkaProperties) {
