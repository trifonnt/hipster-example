...
import name.trifon.example.config.audit.AuditEventConverter;
import name.trifon.example.domain.PersistentAuditEvent;
...
import static name.trifon.example.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
