...
import name.trifon.example.config.Constants;
import name.trifon.example.domain.User;
import name.trifon.example.repository.AuthorityRepository;
import name.trifon.example.repository.UserRepository;
import name.trifon.example.security.AuthoritiesConstants;
import name.trifon.example.service.UserService;
import name.trifon.example.service.dto.PasswordChangeDTO;
import name.trifon.example.service.dto.UserDTO;
import name.trifon.example.web.rest.vm.KeyAndPasswordVM;
import name.trifon.example.web.rest.vm.ManagedUserVM;
...
import static name.trifon.example.web.rest.AccountResourceIT.TEST_USER_LOGIN;
